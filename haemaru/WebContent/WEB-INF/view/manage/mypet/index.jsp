...
ArrayList<MypetVO> list = (ArrayList)request.getAttribute("list");
				...
				<div class="con">
					...
					<div id="bbs">
						<div id="blist">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="반려동물 관리목록입니다.">
								<colgroup>
									<col class="w3" />
									<col class="w5" />
									<col class="w7" />
							...
							<form name="searchForm" id="searchForm" action="index" method="post">
								<div class="search">
									<select name="stype" title="검색을 선택해주세요">
										...
										<option value="breed" <%=Function.getSelected(param.getStype(), "breed") %>>견종</option>
